  ...
  origin: function (origin, callback) {
    ...
    if (process.env.VERCEL_URL) {
      const allowedOrigins = [
        ...
        'https://donexx-q83d.vercel.app' // Your specific Vercel domain
      ];
      ...
      // In development, allow localhost and Vercel domain
      const allowedOrigins = [
        'http://localhost:5000',
        'http://127.0.0.1:5000',
        'http://localhost:3001',
        'http://127.0.0.1:3001',
        'https://donexx-q83d.vercel.app'   // ✅ add this
      ];
...
const geocoder = {
    geocode: async (address) => {
        ...
        try {
            ...
            // Correct MapTiler geocoding API endpoint
            const url = `https://api.maptiler.com/geocoding/v2/geocode/${encodedAddress}.json?key=${apiKey}`;
